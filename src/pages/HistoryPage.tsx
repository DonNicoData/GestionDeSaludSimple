...
/**
 * Pantalla de historial del cliente (Fase 6, ref. post-Fase 7).
 *
 * Vista pura de solo lectura: lista los registros del cliente con su
 * semáforo agregado. La descarga vive exclusivamente en el modal
 * post-guardado (ResultsPage → SaveModal) para evitar redundancia.
 *
 * Detalle por registro al expandir → muestra las 7 evaluaciones.
 * PLAN §7.6 define los mensajes cálidos para cada estado (primer
 * registro, 2-3 registros, 4+, etc.).
 */
