...
**Estado al cierre de este hito:** v0.9.0-fase9

**Última fase completada:** ✅ Fase 9 — PWA instalable + offline (Web App Manifest + Service Worker con Workbox + íconos 192/512/maskable/iOS)

**Próxima fase por hacer:** ⏭️ Fase 10 — APK Android con Capacitor
...
- `v0.9.0-fase9` — PWA: manifest + service worker + íconos *(ESTAMOS AQUÍ)*
